...
export default (file1, file2, formatterName) => { // приходят имена файлов и форматтер
  ...
  switch (formatterName) {
    case 'none':
      return JSON.stringify(deepCompare(parsedData1, parsedData2), null, 4);

    case '':
      return deepCompare(parsedData1, parsedData2);

    default: return stylish(deepCompare(parsedData1, parsedData2));
  }
};
